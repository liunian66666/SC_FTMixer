...
DATA_PATH="ETTh1.csv"
ENC_IN=7; BATCH=1024; FREQ="h"
PHASE_MODE="hour"; CYCLE_LEN=24; SLOTS=1
HIDDEN=192; GATE_INIT="2.0"; NUM_WORKERS=10
...
run_one() {
  ...
  python3 -u main_sde.py \
    ...
    --model_id "${DATA}_96_${pl}_${ABL_VER}_${tag}_h${HIDDEN}" \
