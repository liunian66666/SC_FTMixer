...
ENC_IN=21; BATCH=1024; FREQ="t"
PHASE_MODE="day_slot"; CYCLE_LEN=144; SLOTS=6
...
run_one() {
  ...
  python3 -u main_sde.py \
    ...
    --model_id "Weather_96_${pl}_${ABL_VER}_${tag}_h${HIDDEN}" \
...
run_ablation_set() {
  local pl=$1
  echo "" ; echo "========== Weather pred_len=${pl} ==========" ; echo ""
